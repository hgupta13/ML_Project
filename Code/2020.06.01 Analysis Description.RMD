...
############################
  # install.packages(c('knitr', 'dplyr', 'stringr', 'readr', 'ggplot2', 'rmarkdown', 'kableExtra', 'utils', 'readxl', 'randomForest', 'glmnet', 'clubSandwich', 'sandwich', 'devtools', 'grf', 'reshape2', 'estimatr', 'car', 'aod', 'devtools'))
  library(devtools)
...
Confirming our intiuition, the AIPW estimator is reasonably close to the IPW and unweighted ATE. When we omit group fixed effects from the estimate, 
...
ITT_est <- function(reg_fun) {  
  ...
  ############################
    ...
    lm_robust(rf1, data = df_ipw, weights = weight, clusters = schoolid)
